...
const SingleDonation = ({cardData}) => {
    const {title, image_squre, category, text_color, category_bg, card_bg, amount} = cardData;
    ...
    return (
        <div className={`rounded-lg flex gap-2`} style={{backgroundColor: card_bg}}>
            ...
            <div className="p-4 space-y-2"> 
                ...
                <button className='btn btn-error btn-sm normal-case text-white rounded border-none' style={{backgroundColor: text_color}}>View Details</button>
            </div>
        </div>
    );
};
